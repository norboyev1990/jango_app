...
class ReportData(models.Model):
    ...
    BALANS_SCHET            = models.IntegerField(null=True)
    ...
    SUM_DOG_NOM             = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    SUM_DOG_EKV             = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    ...
    OSTATOK_CRED_SCHET      = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    OSTATOK_PERESM          = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    DATE_PRODL              = models.CharField(max_length=25)
    DATE_POGASH_POSLE_PRODL = models.DateField(null=True)
    OSTATOK_PROSR           = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    DATE_OBRAZ_PROS         = models.DateField(null=True)
    OSTATOK_SUDEB           = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    ...
    VSEGO_ZADOLJENNOST      = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    CLASS_KACHESTVA         = models.CharField(max_length=25)
    OSTATOK_REZERV          = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    OSTATOK_NACH_PRCNT      = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    OSTATOK_NACH_PROSR_PRCNT= models.DecimalField(max_digits=15, decimal_places=2, null=True)
    OCENKA_OBESPECHENIYA    = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    ...
    OSTATOK_VNEB_PROSR      = models.DecimalField(max_digits=15, decimal_places=2, null=True)
